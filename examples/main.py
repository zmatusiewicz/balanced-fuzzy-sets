"""Run the complete artifact-generating demonstration from the source tree."""
...
OUTPUT_DIR = PROJECT_ROOT / "graphical_examples"
RULE_PATH = PROJECT_ROOT / "rules" / "Rule1"
...
if __name__ == "__main__":
    ...
    petri_inspired_network = build_petri_inspired_network_from_process_steps(
        [
            PROJECT_ROOT / "process_steps" / "Step1",
            PROJECT_ROOT / "process_steps" / "Step2",
            PROJECT_ROOT / "process_steps" / "Step3",
        ],
        {
            "T": balanced_t_norm,
            "S": balanced_t_conorm_one,
