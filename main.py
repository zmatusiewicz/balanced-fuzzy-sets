...
from representable_uninorm_generator import additive_generator_of_representable_uninorm
from fuzzy_negations import cosine, dombi_with_fixed_point, negations_summary, power, yager
from fuzzy_norms import fuzzy_norms_summary
...
from nullnorms import nullnorm_from_t_norm_and_t_conorm, nullnorms_summary
...
from rule_builder import build_rule, parse_rule, rule_to_infix
from supplementary_operators import cosine_supplementary_operator
from tnorm_additive_generators import aczel_alsina, literature_summary


OUTPUT_DIR = Path("graphical_examples")
RULE_PATH = Path("rules") / "Rule1"
