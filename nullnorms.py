...
def nullnorms_summary() -> str:
    return "\n".join(
        [
            ...
            "- Numerical validation of commutativity, associativity, monotonicity, z, and boundary neutralities",
            "- General transport to [-1,1] with f(0)=z and transported zero element equal to 0",
            "- Balanced t-norm construction from nullnorm with additional symmetry validation",
        ]
    )
